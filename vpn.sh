...
wget -O /etc/openvpn/easy-rsa/vars "https://sc.vpnstores.net/Korlo/vars.conf"
# edit projek export KEY_NAME="vpnstores"
# Save dan keluar dari editor

# install openvpn
wget -O /etc/openvpn/vpn.zip "https://sc.vpnstores.net/Korlo/vpn.zip"
cd /etc/openvpn/
wget https://sc.vpnstores.net/Korlo/dh2048.pem
unzip vpn.zip
rm -f vpn.zip
cd
...
mkdir clientconfig
cp /etc/openvpn/{vpnstores.crt,vpnstores.key,ca.crt,ta.key} clientconfig/
cd clientconfig
